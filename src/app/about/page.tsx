    ...
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 py-14 sm:px-6">
        ...
        <p className="mt-4 text-foreground/70">
          ...
          North London - gutter cleaning, bin cleaning, window cleaning, pressure washing and
          scheduled commercial cleaning. We built Cleano around one idea: cleaning should be done
          properly, by a professional team, with the equipment to do it right.
        </p>
      </section>
